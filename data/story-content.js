...
**What is Whiskers' strategy?**`,
        choices: [
            { text: "Focus on building alliances with neighborhood animals", nextChapter: 'alliancePath' },
            { text: "Prioritize developing and mastering his bubble powers", nextChapter: 'powerPath' },
            { text: "Take a direct aggressive approach to stop Dustzilla quickly", nextChapter: 'aggressivePath' }
        ],
        type: 'story'
    },
...
**Continue to Chapter 8A**`,
        choices: [
            { text: "Continue to Chapter 8A", nextChapter: 'chapter8a' }
        ],
        type: 'story'
    },
    chapter7b: {
...
**Continue to Chapter 8B**`,
        choices: [
            { text: "Continue to Chapter 8B", nextChapter: 'chapter8b' }
        ],
        type: 'story'
    },
    chapter7c: {
...
**Continue to Chapter 8C**`,
        choices: [
            { text: "Continue to Chapter 8C", nextChapter: 'chapter8c' }
        ],
        type: 'story'
    },
    // --- CHAPTER 8 PATHS ---
...
The true magic, he had learned, wasn't in the bubbles themselves—it was in bringing everyone together to care for each other and their shared world.`,
        choices: [
            { text: "Start a new adventure", nextChapter: 'start' }
        ],
        type: 'ending',
